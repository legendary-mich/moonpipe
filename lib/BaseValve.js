...
function validatePreset(preset) {
  ...
  if (typeof preset.maxBufferSize !== 'number' || preset.maxBufferSize < 0) {
    throw new Error(`Expected maxBufferSize to be a 'number' greater than -1; found: ${preset.maxBufferSize}`)
  }
}
